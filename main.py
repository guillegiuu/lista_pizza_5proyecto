...
# Trabajas en Len's Slice, una pizzería nueva en el barrio. \
# Vas a utilizar tus conocimientos de listas de Python para \ 
# organizar algunos de tus datos de ventas.
